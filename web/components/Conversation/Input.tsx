...
function ChatInput() {
    ...
    return (
        <Paper position="fixed" elevation={2} style={{
            backgroundColor: theme.palette.background.default,
            borderRadius: 0, display: "flex", flexDirection: "column",
            width: isDesktop ? `calc(100% - ${drawerWidth}px)` : "100%", paddingLeft: "1rem", paddingRight: "1rem",
            position: "fixed", bottom: 0, paddingBottom: "0.3rem", paddingTop: "0.3rem"
        }}>
                    ...
                    <div style={{display: "flex", alignItems: "center", marginBottom: "0.25rem"}}>
                        <div>
                            ...
                            <Typography style={{
                                ...
                                width: "70vw", overflowX: "hidden", textOverflow: "ellipsis"
                            }}>
                                {/* @ts-ignore */}
