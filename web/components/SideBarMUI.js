    ...
    return (
        <Fragment>
            ...
            <Dialog open={!!qrCodeOpen} onClose={() => setQrCodeOpen(false)}>
                <Paper style={{padding: "2rem"}}><QRCodeDisplay bgColor={theme.palette.background.paper}
                                                                fgColor={theme.palette.mode === "dark" ? "white" : theme.palette.primary.main}
                                                                value={auth.currentUser.email}/></Paper>
            </Dialog>
                        ...
                        <Paper elevation={0} style={{position: "relative", maxWidth: "30rem",}}>
                            <ButtonBase disabled={!!!email}>
                                ...
                                {!email && <QrReader
                                    ...
                                    style={{width: "100%", height: "auto", padding: 0, margin: 0, objectFit: "cover"}}
                                    onError={() => {
                                    }}
                                    onScan={setEmail}
                                />}</ButtonBase>
