...
import {Add, ChatBubble, Explore, MusicNote, Person} from "@mui/icons-material";
...
const ChatsBottomNavigation = () => {
    ...
    return (
        !isDesktop && (<div><div style={{height: '4rem'}}/><Paper elevation={3} style={{position: 'fixed', paddingBottom: isDesktop ? '0.3rem' : "1.5rem",  bottom: 0, left: 0, width: `100vw`}}>
            <BottomNavigation
